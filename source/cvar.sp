...
void InitializeConVars() {
    ...
    cvRoundTime = CreateConVar("sm_jailbreak_round_time",
        "600", "The round time, in seconds.", FCVAR_NOTIFY, true, 0,
        true, 60 * 30);
    cvWardenFriendlyFire = CreateConVar("sm_jailbreak_warden_friendly_fire",
        "1", "Can the warden set friendly fire?", FCVAR_NOTIFY, true, 0,
        true, 1);
    cvWardenSoftCollisions = CreateConVar("sm_jailbreak_warden_collisions_soft",
        "1", "Can the warden set soft collisions?", FCVAR_NOTIFY, true, 0,
        true, 1);
    cvWardenHardCollisions = CreateConVar("sm_jailbreak_warden_collisions_hard",
        "1", "Can the warden set hard collisions?", FCVAR_NOTIFY, true,  0,
        true, 1);
    cvCriticals = CreateConVar("sm_jailbreak_criticals", "2",
        "Who gets crits? (0 = nobody, 1 = reds, 2 = blues, 3 = all, 4 = warden only)",
        FCVAR_NONE, true, 0, true, 4);
